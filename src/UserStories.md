...
1. **Download & Launch the App**  
   ...
   - Launch the app.  
   ![Download & Launch App Screen](<Screenshot from 2025-03-07 16-47-10.png>)

2. **Enter Registration Details**  
   - Enter your phone number to initiate the registration process.  
   ![Registration - Phone Number Entry Screen](<Screenshot from 2025-03-07 16-47-32.png>)

3. **OTP Verification**  
   - Enter the OTP sent to your phone and click "Verify".  
   ![OTP Verification Screen](<Screenshot from 2025-03-07 16-48-23.png>)

4. **Access Dashboard**  
   - After successful verification, you are redirected to the dashboard, confirming your registration.  
   ![Dashboard After Registration](<Screenshot from 2025-03-07 16-48-51.png>)
...
1. **Navigate to Dashboard**  
   ...
   ![Dashboard Screen](<Screenshot from 2025-03-07 16-48-51.png>)
...
3. **Balance Display**  
   ...
   ![Account Balance Display Screen](image.png)
...
0. **The Recipient Navigates to Dashboard**  
   - Open the WeBank app to access your dashboard.  
   ![Recipient Dashboard Screen](<Screenshot from 2025-03-07 16-48-51.png>)
...
4. **Confirming Transfer Details**  
   ...
   ![Transfer Details Confirmation Screen](image-8.png)
...
5. **Completing the Transfer**  
   ...
   ![Transfer Success Screen](image-9.png)
...
0. **The Seller Navigates to Dashboard**  
   - Open the WeBank app to access your dashboard.  
   ![Seller Dashboard Screen](<Screenshot from 2025-03-07 16-48-51.png>)
...
1. **Access Transaction History**  
   ...
   ![Dashboard - Transaction History Button](<Screenshot from 2025-03-07 16-48-51.png>)

2. **Display History**  
   - Your past transactions are listed on the screen.  
   ![Transaction History List Screen](image-10.png)
...
5. **Display QR Code**  
   ...
   ![Top-Up QR Code Display Screen](image-12.png)
...
5. **Finalize the Transaction**  
   ...
   ![Agent - Transaction Success Screen](image-16.png)
...
5. **User Scans the QR Code**  
   ...
   ![User Scanning Withdrawal QR Code](image-18.png)

6. **Review Transaction Details**  
   - After scanning, a summary of the transaction appears for the user to review.  
   ![Review Withdrawal Transaction Details Screen](image-19.png)
...
7. **Confirm the Transaction**  
   ...
   ![Withdrawal Success Screen](image-20.png)
...
0. **Handling Offline Withdrawals**  
   ...
   ![Offline Mode Notification Screen](image-22.png)
...
1. **Redirect to Amount Page**  
   ...
   ![Offline Mode: Withdrawal Amount Entry Screen](image-23.png)
...
2. **QR Code Generation for Offline Authorization**  
   ...
   ![Offline Mode: Generated QR Code for Authorization](image-24.png)
...
3. **Handoff to the Online Agent**  
   ...
   ![Offline Mode: Handoff QR Code to Agent](image-21.png)

4. **Agent Scanning Process**  
   - The agent is navigated to a dedicated "Scan QR Code" page.  
   - Here, they can either capture a live scan or upload the QR code image provided by the client.  
   - Once the QR code is captured, the agent clicks "Continue."  
   ![Agent Offline Mode: Scanning Client QR Code](image-25.png)
...
5. **Transaction Confirmation**  
   ...
   ![Agent Offline Mode: Confirm Transaction Details](image-26.png)
...
6. **Completion and Success Notification**  
   ...
   ![Offline Mode: Transaction Success Screen](image-28.png)
