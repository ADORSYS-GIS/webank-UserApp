      ...
      <div className="w-full max-w-md p-6 bg-gray-100 shadow-lg rounded-2xl text-center">
        ...
        <div className="mb-4">
          <input
            ...
            className="mt-1 block w-full p-3 border border-gray-300 rounded-xl bg-white focus:ring-2 focus:ring-green-400 focus:outline-none"
            value={email}
            onChange={(e) => setEmail(e.target.value)}
          />
        </div>
        <button
          className="w-full py-3 bg-green-500 text-white font-semibold rounded-full shadow-md hover:bg-green-600 transition"
