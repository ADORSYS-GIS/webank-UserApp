...
import BackId from "./BackId"; // Create similar component
import SelfieId from "./SelfieId"; // Create similar component
import TaxpayerId from "./TaxpayerId"; // Create similar component
