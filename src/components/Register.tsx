...
const countryOptions: CountryOption[] = [
    ...
    { value: '+41', label: 'Switzerland', flag: 'https://flagcdn.com/w40/ch.png' },
    ...
    { value: '+420', label: 'Czech Republic', flag: 'https://flagcdn.com/w40/cz.png' },
    ...
    { value: '+966', label: 'Saudi Arabia', flag: 'https://flagcdn.com/w40/sa.png' },
    { value: '+971', label: 'United Arab Emirates', flag: 'https://flagcdn.com/w40/ae.png' },
    { value: '+92', label: 'Pakistan', flag: 'https://flagcdn.com/w40/pk.png' },
    { value: '+977', label: 'Nepal', flag: 'https://flagcdn.com/w40/np.png' },
    { value: '+880', label: 'Bangladesh', flag: 'https://flagcdn.com/w40/bd.png' },
    ...
    { value: '+994', label: 'Azerbaijan', flag: 'https://flagcdn.com/w40/az.png' },
    ...
    { value: '+258', label: 'Mozambique', flag: 'https://flagcdn.com/w40/mz.png' },
    { value: '+236', label: 'Central African Republic', flag: 'https://flagcdn.com/w40/cf.png' },
    { value: '+243', label: 'Democratic Republic of the Congo', flag: 'https://flagcdn.com/w40/cd.png' },
    { value: '+260', label: 'Zambia', flag: 'https://flagcdn.com/w40/zm.png' },
    { value: '+261', label: 'Madagascar', flag: 'https://flagcdn.com/w40/mg.png' },
...
const Register: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-white px-6 lg:px-20 lg:py-10">
            <div className="mt-10">
                <img src={WebankLogo} alt="WeBank Logo" className="w-auto h-60 lg:w-60 -mt-10"/>
            </div>

            <div className="text-center mt-6">
                <h1 className="text-xl font-bold lg:text-2xl">Register for a bank account</h1>
                <p className="text-gray-500 lg:text-lg">Please enter your phone number</p>
            </div>

            <div className="mt-8 w-full max-w-sm lg:max-w-md">
                <label htmlFor="phone" className="block text-left font-medium">Phone Number</label>
                    ...
                    <div className="relative w-1/3">
                        ...
                        >
                            <div className="flex items-center">
                                <img src={selectedCountry?.flag} alt="" className="w-6 h-4 mr-2"/>
                        ...
                        {isOpen && (
                            <div
                                className="absolute z-10 w-full bg-white border rounded-lg shadow-lg mt-1 max-h-64 overflow-auto">
                                <input
                                    type="text"
